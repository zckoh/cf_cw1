...
plt.scatter(max_sr_std, max_sr_ret,marker = 's',s = 200,c='m')
plt.scatter(opt_x[1], opt_x[0],marker = 's',s=200,c='darkgreen')
plt.scatter(min_sr_std, min_sr_ret,marker= 's',s=200,c='m')
...
for stock_df, allocation in zip((MRW_2nd_half, HRGV_2nd_half, GLEN_2nd_half),portf_weights):
...
plt.style.use('fivethirtyeight')
naive_vs_new_portf.columns = ['Naive Pos','New Pos']
