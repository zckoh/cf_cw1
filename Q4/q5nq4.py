...
optimal_weights_min_var = mat['optimal_weights']

mat = scipy.io.loadmat('../Q5/results/g_min_c_weights.mat', squeeze_me=True)
optimal_weights_g_min_c = mat['optimal_weights']
...
# =============================================================================
# Assuming portfolio size is £10000
portf_weights = optimal_weights_min_var
...
minvar_portf_val = pd.concat(all_pos, axis=1)
minvar_portf_val.columns = ['Date','MRW Pos','HRGV Pos','GLEN Pos']

# Add total position of the portfolio
minvar_portf_val['Total Pos'] = minvar_portf_val.sum(axis=1)

# Add overall daily return from portfolio
minvar_portf_val['Daily Return'] = minvar_portf_val['Total Pos'].pct_change(1)

# Plot the results
minvar_portf_val.set_index('Date', inplace=True)
print("Graph for Total Pos using efficient portfolio")
minvar_portf_val['Total Pos'].plot(figsize=(10,8))
plt.savefig('./plots/newPortfTotalPos.png',dpi=300,
            bbox_inches='tight', pad_inches=0)

print("Graph for individual position for each stock in portfolio")
minvar_portf_val.drop(['Total Pos','Daily Return'], axis=1).plot(figsize=(10,8))
plt.savefig('./plots/newPortfIdvPos.png',dpi=300,
            bbox_inches='tight', pad_inches=0)
plt.show()

# Calculate the Sharpe Ratio
Sharpe_Ratio = minvar_portf_val['Daily Return'].mean() / minvar_portf_val['Daily Return'].std()
print("Sharpe Ratio for min-var portfolio: ", "%.5f" % Sharpe_Ratio)


# =============================================================================
# Now we compute the return similarly for the g_min_c portfolio
# =============================================================================
# Assuming portfolio size is £10000
portf_weights = optimal_weights_g_min_c
...
# Combine all position in a single table
all_pos = [pd.to_datetime(MRW_new_portf['Date']), MRW_new_portf['Position'], HRGV_new_portf['Position'], GLEN_new_portf['Position']]
gminc_portf_val = pd.concat(all_pos, axis=1)
gminc_portf_val.columns = ['Date','MRW Pos','HRGV Pos','GLEN Pos']

# Add total position of the portfolio
gminc_portf_val['Total Pos'] = gminc_portf_val.sum(axis=1)

# Add overall daily return from portfolio
gminc_portf_val['Daily Return'] = gminc_portf_val['Total Pos'].pct_change(1)

# Plot the results
gminc_portf_val.set_index('Date', inplace=True)
print("Graph for Total Pos using g-min-c portfolio")
gminc_portf_val['Total Pos'].plot(figsize=(10,8))
# =============================================================================
# plt.savefig('./plots/newPortfTotalPos.png',dpi=300,
#             bbox_inches='tight', pad_inches=0)
# =============================================================================
...
print("Graph for individual position for each stock in portfolio")
gminc_portf_val.drop(['Total Pos','Daily Return'], axis=1).plot(figsize=(10,8))
# =============================================================================
# plt.savefig('./plots/newPortfIdvPos.png',dpi=300,
#             bbox_inches='tight', pad_inches=0)
# =============================================================================
...
# Calculate the Sharpe Ratio
Sharpe_Ratio = gminc_portf_val['Daily Return'].mean() / gminc_portf_val['Daily Return'].std()
print("Sharpe Ratio for new portfolio: ", "%.5f" % Sharpe_Ratio)

# =============================================================================
# Now we compare the three portfolios
# =============================================================================
compare_portf = pd.concat([naive_portf_val['Total Pos'],
                                minvar_portf_val['Total Pos'],gminc_portf_val['Total Pos']], axis=1)
compare_portf.columns = ['Naive Pos','Min-Var Pos','G-min-c Pos']
print("\nComparing the 3 portfolio's total position.")
compare_portf.plot(figsize=(10,8))
plt.savefig('./plots/q5compare.png',dpi=300,
            bbox_inches='tight', pad_inches=0)
plt.show()
